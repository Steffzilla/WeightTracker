...
public final class ThirdPartyLibraries {
    ...
    private static final List<ThirdPartyLibrary> LIBRARIES = List.of(
            new ThirdPartyLibrary("AndroidX AppCompat", "1.8.0", "Apache-2.0"),
            new ThirdPartyLibrary("AndroidX Activity", "1.13.0", "Apache-2.0"),
            new ThirdPartyLibrary("AndroidX ConstraintLayout", "2.2.2", "Apache-2.0"),
            new ThirdPartyLibrary("AndroidX RecyclerView", "1.4.0", "Apache-2.0"),
            new ThirdPartyLibrary("AndroidX Room", "2.8.5", "Apache-2.0"),
            new ThirdPartyLibrary("AndroidX Lifecycle", "2.11.0", "Apache-2.0"),
            new ThirdPartyLibrary("AndroidX Preference", "1.2.1", "Apache-2.0"),
            new ThirdPartyLibrary("Material Components for Android", "1.14.0", "Apache-2.0"));
